...
choco install 7zip autoruns brave discord everything firefox nilesoft-shell nordvpn notion paint.net putty rdm sharex steam tidal ubisoft-connect veracrypt virtualbox vlc vscode winscp
