...
choco install 7zip autoruns discord everything nilesoft-shell nordvpn notion paint.net putty rdm sharex steam tidal ubisoft-connect veracrypt virtualbox vivaldi vlc vscode winscp
