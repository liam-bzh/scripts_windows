...
choco install 7zip autoruns discord everything nilesoft-shell notion paint.net protonvpn putty rdm sharex steam tidal ubisoft-connect veracrypt virtualbox vivaldi vlc vscode winscp
